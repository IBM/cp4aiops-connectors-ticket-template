package com.ibm.aiops.connectors.importer.models;
...
public class TicketExtended extends Ticket {
    ...
    public String getOpened_at() {
        return Util.getStringFromDate(this.opened_at);
    }
    ...
    public String getClosed_at() {
        return Util.getStringFromDate(this.closed_at);
    }
    ...
    public HashMap<String, Object> getHashMap() {
        ...
        hashMap.put(key_closed_at, Util.getStringFromDate(closed_at));
        hashMap.put(key_opened_at, Util.getStringFromDate(opened_at));
        hashMap.put(key_sys_updated_on, Util.getStringFromDate(sys_updated_on));
        hashMap.put(key_sys_created_on, Util.getStringFromDate(sys_created_on));
